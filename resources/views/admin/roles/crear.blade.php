    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="glass-card">
                ...
                <form action="{{ route('admin.roles.guardar') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="nombre"
                                ...
                                value="{{ old('nombre') }}" required placeholder="Ej. Editor de Contenido">
                            @error('nombre') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-12 mt-4">
                            <label class="form-label fw-bold mb-3 d-block">Asignar Permisos al Rol</label>
                            <div class="row g-3">
                                @foreach($permisos as $permiso)
                                    <div class="col-md-3">
                                        <div class="form-check card-checkbox p-3 border rounded shadow-sm">
